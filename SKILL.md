...
description: 中文网文、小说、长篇连载创作指导 skill。用于创意、选题、故事引擎、大纲、人物、世界观、章节章纲、正文 A/B/C 稿、续写、审稿、修订、去 AI 味、连续性记录、男频悬疑脑洞/推理执行、人物独立动机、信息边界、优秀小说案例方法学习和长期项目管理。
---
...
4. 按 `references/writer-oriented-literary-analysis-protocol.md` 进行写作者导向分析。
5. 补充 `references/excellent-novel-case-methods.md`。
6. 如会影响章节流程，同步补充 `SKILL.md` 和 `references/web-novel-craft.md`。
7. 每个分析部分都必须回答：这对我的小说创作有什么用？
