...
💡 这是一个面向智能体的中文小说/网文写作指导技能，用于指导 智能体作为长期创作项目的写作主脑工作，而不是一次性文本生成器。
...
```text
使用 网文小说写作指导skill，根据我的修改意见先分类反馈，再把这一章改成修改稿。保留我满意的部分。
```

```text
内容方向已经确认。使用 网文小说写作指导skill 做 C 稿去除机器味，不要改设定和情节结果，最后输出连续性记录。
```
